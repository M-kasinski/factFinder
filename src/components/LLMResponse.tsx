  ...
  return (
    <div className="space-y-4">
      ...
      {isLoading && !streamingContent ? (
        <div className="rounded-lg border border-border/50 p-6 bg-card/80 backdrop-blur-sm relative overflow-hidden min-h-[150px]">
        ...
        <Card className="p-6 min-h-[150px] bg-card/90 backdrop-blur-sm border-primary/10 hover:border-primary/20 transition-colors">
